      ...
      >
        <div
          style={{
            ...
            // glared on dark.
            background:
              "color-mix(in oklab, var(--fern-foreground, #18181b) 4%, var(--fern-surface, #ffffff))",
          }}
        />
        <div
          style={{
            ...
            background:
              "color-mix(in oklab, var(--fern-foreground, #18181b) 8%, var(--fern-surface, #ffffff))",
        ...
        >
          <path
            fillRule="nonzero"
            fill="color-mix(in oklab, var(--fern-foreground, #18181b) 20%, transparent)"
