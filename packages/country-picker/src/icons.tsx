      ...
      >
        <div
          style={{
            ...
            background:
              "color-mix(in oklab, var(--foreground, #18181b) 9%, var(--surface, #ffffff))",
          }}
        />
        <div
          style={{
            ...
            boxShadow:
              "inset 0 2px 3px rgb(0 0 0 / 0.2), 0 2px 3px rgb(0 0 0 / 0.2)",
          }}
        />
        <svg
        ...
        >
          <path
            fillRule="nonzero"
            fill="color-mix(in oklab, var(--foreground, #18181b) 30%, transparent)"
